...
##################################
PROJECT_NAME: str = "OD-WeaponDetection: Knife Classification"
PROJECT_NAME_FULL: str = "OD-WeaponDetection: Knife Classification"
...
PREVIEW_IMAGE_ID: int = 7482623
# This should be filled AFTER uploading images to instance, just ID of any image.

GITHUB_URL: str = "https://github.com/dataset-ninja/od-weapon-detection-knife-classification"
...
PAPER: Optional[Union[str, List[str], Dict[str, str]]] = ["https://www.sciencedirect.com/science/article/abs/pii/S0925231218313365"]
